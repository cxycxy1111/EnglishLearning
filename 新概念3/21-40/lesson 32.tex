\section{Lesson 32 A lost ship}

\begin{paracol}{2}

The \nw{salvage} operation had been a complete failure.

\switchcolumn

\chinesetext{打捞工作彻底失败了。}

\switchcolumn*

The small ship, Elkor, which had been searching the \nw{Barents} Sea for weeks, was on its way home.

\switchcolumn

\chinesetext{小船"埃尔科"号在巴伦支海搜寻了几个星期之后，正在返航途中。}
...
\chinesetext{返航前，该船船长收到了大陆发来的电报，指示他们放弃这次搜寻。}

\switchcolumn*

The captain knew that another attempt would be made later, for the \nw{sunken} ship he was trying to find had been carrying a precious \nw{cargo} of gold \nw{bullion}.

\switchcolumn

\chinesetext{船长知道日后还会再作尝试，因为他试图寻找的沉船上载有一批珍贵的金条。}
\nwe{sunken}{}{}
...
\chinesetext{尽管船长接了电报，他还是决定再试一试。}

\switchcolumn*

The sea bed was \nw{scoured} with powerful nets and there was tremendous excitement on board when a \nw{chest} was raised from the bottom.

\switchcolumn

\chinesetext{他们用结实的网把海床搜索了一遍。当一只箱子从海底被打捞上来时，甲板上人们激动不已。}

\switchcolumn*

Though the crew were at first under the impression that the lost ship had been found, the \nw{contents} of the chest proved them wrong.

\switchcolumn

\chinesetext{船员们开始认为沉船找着了，但海底沉箱内的物品证明他们弄错了。}
...
\chinesetext{事实上，他们发现的是另一艘沉没多年的船。}

\switchcolumn*

The chest contained the personal \nw{belongings} of a seaman, Alan Fielding.

\switchcolumn

\chinesetext{木箱内装有水手艾伦.菲尔丁的私人财物。}
...
\chinesetext{其中有书箱、衣服、照片以及水手收到的妻子的来信。}

\switchcolumn*

The captain of the Elkor ordered his men to salvage as much as possible from the \nw{wreck}.

\switchcolumn

\chinesetext{"埃尔科"号船长命令船员们尽量从沉船中打捞物品。}
...
\chinesetext{但没发现什么值钱的东西，不过打捞出来的众多的物品还是引起了大家极大的兴趣。}
...
\chinesetext{从捞起的一门大炮来看，船长认为那艘船一定是艘巡洋舰。}
...
\chinesetext{另一只海底沉箱中装的是船上一位军官的财物，其中有一封写于1943年3月14日的信，但没有写完。}
...
\chinesetext{从这封信中船长了解到沉船船名是"卡伦"号。}

\switchcolumn*

The most valuable \nw{find} of all was the ship's log book, parts of which it was still possible to read.

\switchcolumn

\chinesetext{打捞到的东西中最有价值的是船上的航海日志，其中有一部分仍然清晰可读。}
...
\chinesetext{据此，船长可以将所有的那些已经搞清的材料拼凑起来。}
...
\chinesetext{"卡伦"号当年在为其他船只护航驶往俄国的途中突然遭到敌方潜水艇鱼雷的袭击。}
...
\chinesetext{这一说法在"埃尔科"号返航后得到的国防部一位海军官员的证实。}
...
\chinesetext{那次打捞到的所有物品均被送往军事博物馆。}
