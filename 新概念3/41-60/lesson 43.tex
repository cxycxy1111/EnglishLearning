\section{Lesson 43 Fully insured}
\begin{paracol}{2}
...
\chinesetext{承办公共财产或私人财产保险是世界上大部分国家的正常业务。}
...
\chinesetext{如果你要举办一次露天游园会或盛宴，为避免碰上不好的天气而遭受损失也同样可以保险。}
...
\chinesetext{不用说，保险公司承担风险越大，你付的保险费也就越高。}
...
\chinesetext{航运公司为打捞沉船而提出索赔，这是常有的事。}
...
\chinesetext{但某地当局为打捞一只焙制馅饼的盘子提出索赔，倒是件新鲜的事儿。}
...
\chinesetext{这个馅饼盘子确实少见，有18英尺长，6英尺宽。}
...
\chinesetext{某地方当局买下它用来焙制一个巨大的馅饼为一年一度交易会助兴。}
...
\chinesetext{馅饼委员会确认运输这只盘子的最佳方案是通过运河水运。于是，他们对这只盘子的运输安全投了保。}
...
\chinesetext{盘子下水后不久，馅饼委员会成员们来到当地一家小酒店庆贺。}
...
\chinesetext{就在这个时候，许多十几岁的孩子爬盘子举行他们自己的集会。}
...
\chinesetext{他们跳起了舞，盘子难以承受。舞会进行过程中，盘子倾覆，沉入了7英尺深的水中。}
...
\chinesetext{馅饼委员会给当地汽车修理库老板打电话，他闻讯后开着一辆急修车前来打捞盘子。}
...
\chinesetext{那些孩子们穿着湿衣服哆嗦，看着3个工人轮潜入水中以确定盘子的位置。}
...
\chinesetext{他们没费多大事儿就找到了盘子。可是把盘子捞出却是一个很大的难题。}
...
\chinesetext{盘子四边十分光滑，要在盘边拴上绳索或链条而同时又不损坏它是很难办到的。}
...
\chinesetext{不过，他们终于将链条固定在盘子的一端，一台大功率的绞车开动起来。}
...
\chinesetext{盘子慢慢浮出水面，被轻轻地拽向运河岸边。}
...
\chinesetext{在令人忐忑不安的瞬间，盘子晃晃悠悠地上了岸，但它突然失去了平衡，又跌回水中。}
...
\chinesetext{这次，他们用沉重的金属夹子把盘子夹住，以便往盘子上安装铁链。}
...
\chinesetext{这次，盘子必须垂直吊出水面，因为盘子的一边紧靠着运河河岸。}
...
\chinesetext{绞盘机再次启动，一位工人发动了急修车的引擎。}
...
\chinesetext{波浪从盘子两侧急涌而出，在运河里掀起一股大浪。}
...
\chinesetext{但是当波浪从河对岸折回来时，就有再次把盘子拖进水里的危险。}
...
\chinesetext{工人们动作迅速，终于赶在那股大浪返回之前把盘子拽到了岸上。}
